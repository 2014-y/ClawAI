...
| 5 | [双击 start-gateway.bat 启动](#5-启动-gateway) | 1 分钟 |

> 全部完成后，参考 [接入微信](#接入微信可选) 或 [配置本地模型](#配置本地-ollama-模型可选)。
...
1. **[INSTALL.md](INSTALL.md)** — 从零开始的完整安装指南（含 Node.js 安装、openclaw 安装等）
...
| 问题 | 解决方法 |
|------|---------|
| 双击 start-gateway.bat 闪退 | 先运行 init.bat 初始化 |
